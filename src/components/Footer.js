  ...
  return (
    <footer className="bg-gray-200 shadow dark:bg-gray-800">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          <span className="text-sm font-bold text-gray-800 sm:text-center dark:text-gray-400"><Link to="/" className="hover:underline">Cinemate</Link> 2024
        </span>
        <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-medium-gray dark:text-gray-400 sm:mt-0">
            <li>
