      ...
      <nav className="border-gray-200 bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id="mobile-nav" className="flex md:order-2">
            <button id="dark-mode" onClick={ () => setDarkMode(!darkMode) } type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5 me-1">
              {darkMode ? (
