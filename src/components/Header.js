...
export const Header = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // TODO: fix bug, won't refresh if navigating from search page
      ...
      <nav className="border-gray-200 bg-gray-200 dark:bg-gray-800 dark:border-medium-gray">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-light-gray">Cinemate</span>
          </Link>
